    ...
    return {
        ...
        link: function ($scope, elem)
        {
            ...
            $scope.selectResult = function (result)
            {
                ...
                $scope.showDropdown = false;
                $scope.results = [];
                console.log($scope.clearSelection);
